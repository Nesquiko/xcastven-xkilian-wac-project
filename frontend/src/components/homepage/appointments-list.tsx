    ...
    return (
      <div class="w-full overflow-hidden rounded-lg bg-white shadow-sm">
        ...
        <div class="flex h-12 w-full flex-row items-center justify-between">
          <md-icon-button title="View older appointments" class="m-1" onClick={() => console.log('view older appointments clicked')}>
            <md-icon class="text-gray-600">arrow_back</md-icon>
          </md-icon-button>
          <md-icon-button title="Schedule an appointment" class="m-1 w-20" onClick={() => console.log('schedule an appointment')}>
            <md-icon class="text-gray-600">calendar_month</md-icon>
            <md-icon class="text-gray-600">add</md-icon>
          </md-icon-button>
          <md-icon-button title="View newer appointments" class="m-1" onClick={() => console.log('view newer appointments clicked')}>
